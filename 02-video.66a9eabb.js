 ...
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
if(!window.VimeoCheckedUrlTimeParam){window.VimeoCheckedUrlTimeParam=!0;var t=function(e){"console"in window&&console.error&&console.error("There was an error getting video Id: ".concat(e))};window.addEventListener("message",function(n){if(_(n.origin)){var r=D(n.data);if(r&&"ready"===r.event)for(var o=e.querySelectorAll("iframe"),i=0;i<o.length;i++)!function(){var e=o[i],r=e.contentWindow===n.source;if(S(e.src)&&r){var a=new X(e);a.getVideoId().then(function(e){var t=new RegExp("[?&]vimeo_t_".concat(e,"=([^&#]*)")).exec(window.location.href);if(t&&t[1]){var n=decodeURI(t[1]);a.setCurrentTime(n)}}).catch(t)}}()}})}}());var K=l("9OeKo");const Z=document.querySelector(".js-iframe-video"),ee=new X(Z,{id:19231868,width:640});ee.on("timeupdate",(K&&K.__esModule?K.default:K)(function(e){(function(e,t){try{localStorage.setItem(e,JSON.stringify(t))}catch(e){console.log(e.message)}})("videoplayer-current-time",e.seconds)},1e3)),ee.setCurrentTime(function(e){try{return JSON.parse(localStorage.getItem(e))||{}}catch(t){return console.log(t.message),localStorage.getItem(e)}}//# sourceMappingURL=02-video.66a9eabb.js.map
("videoplayer-current-time")).then(function(e){}).catch(function(e){e.name});
//# sourceMappingURL=02-video.66a9eabb.js.map
